...
```text
       ...
       v                         v                         v
+--------------+          +--------------+          +--------------+
| DESIGN AGENT |          | CODE AGENT   |          | ASSET AGENT  |
+--------------+          +--------------+          +--------------+
       |                         |                         |
       +-------------------------+-------------------------+
                                 |
         ...
         v                                               v
+------------------+                           +-------------------+
|  HTML/Web Engine |                           |    Unity Engine   |
| (Canvas / 3D)    |                           | (C# / Batch Mode) |
+------------------+                           +-------------------+
         |                                               |
         +-----------------------+-----------------------+
                                 |
